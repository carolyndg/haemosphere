...
Schultze_expression <- read.delim("Haemosphere datasets/Schultze/Schultze_expression.txt",row.names = 1)
Schultze_samples <- read.delim("Haemosphere datasets/Schultze/Schultze_samples.txt",row.names = 1)
# Schultze_probes <- read.delim("Haemosphere datasets/Schultze/Schultze_probes.txt",col.names = c("V1","V2"))
